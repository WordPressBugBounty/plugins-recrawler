...
namespace Mihdan\ReCrawler\Dependencies\GuzzleHttp\Exception;

use Mihdan\ReCrawler\Dependencies\GuzzleHttp\BodySummarizer;
use Mihdan\ReCrawler\Dependencies\GuzzleHttp\BodySummarizerInterface;
use Mihdan\ReCrawler\Dependencies\Psr\Http\Client\RequestExceptionInterface;
...
class RequestException extends TransferException implements RequestExceptionInterface
{
    ...
    public static function create(RequestInterface $request, ?ResponseInterface $response = null, ?\Throwable $previous = null, array $handlerContext = [], ?BodySummarizerInterface $bodySummarizer = null) : self
    {
        ...
        $uri = \Mihdan\ReCrawler\Dependencies\GuzzleHttp\Psr7\Utils::redactUserInfo($request->getUri());
