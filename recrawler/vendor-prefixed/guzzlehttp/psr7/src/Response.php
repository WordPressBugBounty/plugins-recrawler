...
class Response implements ResponseInterface
{
    ...
    public function withStatus($code, $reasonPhrase = '') : ResponseInterface
    {
        ...
        if (!\is_string($reasonPhrase)) {
            \Mihdan\ReCrawler\Dependencies\trigger_deprecation('guzzlehttp/psr7', '2.11', 'Passing %s to ResponseInterface::withStatus() is deprecated; guzzlehttp/psr7 3.0 requires string for $reasonPhrase.', \get_debug_type($reasonPhrase));
        }
