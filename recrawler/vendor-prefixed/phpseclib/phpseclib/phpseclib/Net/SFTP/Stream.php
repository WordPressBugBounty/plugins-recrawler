 ...
 */
namespace Mihdan\ReCrawler\Dependencies\phpseclib3\Net\SFTP;

use Mihdan\ReCrawler\Dependencies\phpseclib3\Crypt\Common\PrivateKey;
use Mihdan\ReCrawler\Dependencies\phpseclib3\Net\SFTP;
...
class Stream
{
    ...
    {
        if (\defined('Mihdan\\ReCrawler\\Dependencies\\NET_SFTP_STREAM_LOGGING')) {
            echo "__construct()\r\n";
        }
    }
    /**
