...
namespace Mihdan\ReCrawler\Dependencies\Firebase\JWT;

use ArrayAccess;
use InvalidArgumentException;
use LogicException;
use OutOfBoundsException;
use Mihdan\ReCrawler\Dependencies\Psr\Cache\CacheItemInterface;
use Mihdan\ReCrawler\Dependencies\Psr\Cache\CacheItemPoolInterface;
use Mihdan\ReCrawler\Dependencies\Psr\Http\Client\ClientInterface;
