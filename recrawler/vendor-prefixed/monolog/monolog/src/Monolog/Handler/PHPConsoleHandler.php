...
use Mihdan\ReCrawler\Dependencies\PhpConsole\Connector;
use Mihdan\ReCrawler\Dependencies\PhpConsole\Handler as VendorPhpConsoleHandler;
use Mihdan\ReCrawler\Dependencies\PhpConsole\Helper;
use Mihdan\ReCrawler\Dependencies\Monolog\LogRecord;
use Mihdan\ReCrawler\Dependencies\PhpConsole\Storage;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('Mihdan\\ReCrawler\\Dependencies\\PhpConsole\\Connector')) {
