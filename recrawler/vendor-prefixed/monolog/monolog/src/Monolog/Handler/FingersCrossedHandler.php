...
use Closure;
use Mihdan\ReCrawler\Dependencies\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use Mihdan\ReCrawler\Dependencies\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
