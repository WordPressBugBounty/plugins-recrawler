...
use Mihdan\ReCrawler\Dependencies\Google\Auth\Credentials\ExternalAccountCredentials;
use Mihdan\ReCrawler\Dependencies\Google\Auth\Credentials\ImpersonatedServiceAccountCredentials;
use Mihdan\ReCrawler\Dependencies\Google\Auth\Credentials\InsecureCredentials;
...
abstract class CredentialsLoader implements GetUniverseDomainInterface, FetchAuthTokenInterface, UpdateMetadataInterface
{
    ...
    public static function makeHttpClient(FetchAuthTokenInterface $fetcher, array $httpClientOptions = [], ?callable $httpHandler = null, ?callable $tokenCallback = null)
    {
        ...
        $stack = \Mihdan\ReCrawler\Dependencies\GuzzleHttp\HandlerStack::create();
        $stack->push($middleware);
        return new \Mihdan\ReCrawler\Dependencies\GuzzleHttp\Client(['handler' => $stack, 'auth' => 'google_auth'] + $httpClientOptions);
    }
    /**
