...
use Mihdan\ReCrawler\Dependencies\Google\Auth\Middleware\ScopedAccessTokenMiddleware;
use Mihdan\ReCrawler\Dependencies\Google\Auth\Middleware\SimpleMiddleware;
