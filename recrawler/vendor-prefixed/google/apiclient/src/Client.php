 ...
 */
namespace Mihdan\ReCrawler\Dependencies\Google;

use BadMethodCallException;
use DomainException;
use Mihdan\ReCrawler\Dependencies\Google\AccessToken\Revoke;
use Mihdan\ReCrawler\Dependencies\Google\AccessToken\Verify;
use Mihdan\ReCrawler\Dependencies\Google\Auth\ApplicationDefaultCredentials;
use Mihdan\ReCrawler\Dependencies\Google\Auth\Cache\MemoryCacheItemPool;
use Mihdan\ReCrawler\Dependencies\Google\Auth\Credentials\ServiceAccountCredentials;
use Mihdan\ReCrawler\Dependencies\Google\Auth\Credentials\UserRefreshCredentials;
use Mihdan\ReCrawler\Dependencies\Google\Auth\CredentialsLoader;
use Mihdan\ReCrawler\Dependencies\Google\Auth\FetchAuthTokenCache;
use Mihdan\ReCrawler\Dependencies\Google\Auth\FetchAuthTokenInterface;
use Mihdan\ReCrawler\Dependencies\Google\Auth\GetUniverseDomainInterface;
use Mihdan\ReCrawler\Dependencies\Google\Auth\HttpHandler\HttpHandlerFactory;
use Mihdan\ReCrawler\Dependencies\Google\Auth\OAuth2;
use Mihdan\ReCrawler\Dependencies\Google\AuthHandler\AuthHandlerFactory;
use Mihdan\ReCrawler\Dependencies\Google\Http\REST;
use Mihdan\ReCrawler\Dependencies\GuzzleHttp\Client as GuzzleClient;
use Mihdan\ReCrawler\Dependencies\GuzzleHttp\ClientInterface;
use Mihdan\ReCrawler\Dependencies\GuzzleHttp\Ring\Client\StreamHandler;
use InvalidArgumentException;
use LogicException;
use Mihdan\ReCrawler\Dependencies\Monolog\Handler\StreamHandler as MonologStreamHandler;
use Mihdan\ReCrawler\Dependencies\Monolog\Handler\SyslogHandler as MonologSyslogHandler;
